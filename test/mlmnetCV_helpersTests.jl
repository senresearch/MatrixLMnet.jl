...
@testset "Testing minimize_rows function" begin
    ...
    @test MatrixLMnet.minimize_rows([CartesianIndex(1, 1), CartesianIndex(2, 2), CartesianIndex(3, 2)]) == [CartesianIndex(1, 1), CartesianIndex(2, 2)]

    # Test with non-sequential columns
    @test MatrixLMnet.minimize_rows([CartesianIndex(3, 5), CartesianIndex(2, 1)]) == [CartesianIndex(2, 1), CartesianIndex(3, 5)]
    ...
    @test MatrixLMnet.minimize_rows([CartesianIndex(4, 3), CartesianIndex(1, 3), CartesianIndex(2, 4), CartesianIndex(3, 4)]) == [CartesianIndex(1, 3), CartesianIndex(2, 4)]
end
