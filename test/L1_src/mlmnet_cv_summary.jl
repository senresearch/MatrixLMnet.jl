...
"""
function calc_avg_mse(MLMNet_cv::Mlmnet_cvDeprecated) 
...
"""
function calc_avg_prop_zero(MLMNet_cv::Mlmnet_cvDeprecated)
...
"""
function mlmnet_cv_summary(MLMNet_cv::Mlmnet_cvDeprecated)
