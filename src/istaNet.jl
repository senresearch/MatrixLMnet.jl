...
"""
function update_istaNet!(B::AbstractArray{Float64,2}, 
...
"""
    istaNet!(X, Y, Z, , B, regXidx, regZidx, reg, norms; 
...
"""
function istaNet!(X::AbstractArray{Float64,2}, Y::AbstractArray{Float64,2}, 
